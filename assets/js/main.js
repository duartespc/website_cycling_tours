...
const translations = {
  "pt": {
    ...
    "tourEspichelDescription": "Um local muito popular de peregrinação no passado, perto da vila de Sesimbra, onde pode visitar uma bela igreja construída no século XVII e apreciar vistas deslumbrantes sobre o Oceano Atlântico.",
    "tourFatimaDescription": "O Santuário de Fátima é um local de peregrinação que celebra a memória do seu evento fundador, as aparições de Nossa Senhora aos três pastorinhos. A hospitalidade pastoral aos peregrinos é um elemento fundamental da sua missão.",
    ...
    "tourEN2": "Tour EN2 - 6 a 10 dias",
    "tourEN222": "Tour EN2 - 3 dias",
  ...
  "en": {
    ...
    "aboutUsPart2": "You may ask why we chose “Chain Cycling Tours”. Well, for us the key part of the name is the “Chain”. In cycling language, we all know what it means but in common language can also mean a bond and that's precisely what our end game is.",
    ...
    "tourEspichelDescription": "A very popular place of pilgrimage in the past, close to the villa of Sesimbra, where you can visit a beautiful church built in the 17th Century and appreciate stunning views over the  Atlantic Ocean.",
    "tourFatimaDescription": "The Shrine of Fatima is a place of pilgrimage, which celebrates the memory of its founding event, the apparitions of Our Lady to the three little Shepherds. The pilgrim’s pastoral hospitality is a key element to its mission.",
    ...
    "tourEN2": "Tour EN2 - 6 to 10 days",
    "tourEN222": "Tour EN2 - 3 days",
    "customTourDescription": "",
    "bikeRentalDescription": "",
    "helmetRentalDescription": "",
